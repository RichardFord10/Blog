 ...
 <div x-show="tab === 'about'" x-cloak>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 justify-center">
            ...
            <div class="bg-white dark:bg-gray-700 shadow overflow-hidden mb-4 flex flex-col h-full">
                <div class="flex flex-col items-center justify-center mt-1 mb-1">
                    @isset($info->image)
                    <img src="{{ asset('storage/' . $info->image) }}" alt="Profile Image"
                    class="rounded-full object-cover" style="width: 100px; height: 100px;">
                    <h4 class="mt-2 font-bold text-gray-800 dark:text-white">{{ $info->first_name }} {{ $info->last_name }}</h4>
                    @endisset
                </div>
                <div class="flex flex-col flex-grow p-4 text-center">
                    <p class="text-sm text-gray-600 dark:text-gray-300 flex-grow">
