...
<div class="mt-10 px-4">
    ...
    @isset($entity)
    <div data-aos="fade-up" data-aos-anchor-placement="top-center" class=" dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden mb-6 transition-shadow duration-300 hover:shadow-xl">
        <!-- Full-width image -->
