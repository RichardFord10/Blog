<div class="mt-10 px-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-center">
        ...
        <div data-aos="fade-up" style="" data-aos-anchor-placement="top-center" class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden mb-6 p-6 transition-shadow duration-300 hover:shadow-xl">
            <a target="_blank" href="{{ $social->link }}" class="block hover:underline hover:text-blue-500">
                <img class="h-45 w-full object-cover rounded-t-lg mt-2 mx-auto" src="{{ asset('storage/' . $social->image) }}" alt="Social Image">
