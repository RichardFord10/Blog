<div>
    <div class="container mx-auto p-4 max-w-4xl">
        ...
        <div class="flex justify-between items-center">
            <div class="py-4 text-center w-full text-white">
                {!! $entity->title !!}
            </div>
        </div>
        <div class="bg-gray-800 rounded-lg shadow overflow-hidden mx-auto">
            <div class="p-4">
                <p class="font-body text-gray-300 mt-2">
                <article class="prose-invert mx-auto items-center">
                    {!! $entity->content !!}</p>
                </article>
