                ...
                <div class=" dark:bg-gray-800 rounded-lg shadow overflow-hidden mb-4 flex flex-col h-full">
                    <div class="inline-block">
                        <div class="text-center">
                            @isset($info->image)
                            <div class="inline-block">
                                <img src="{{ asset('storage/' . $info->image) }}" alt="Profile Image" class="rounded-full object-cover object-center" style="max-width: 100px; max-height: 100px;">
                            </div>
                            @endisset
                            <div class="mt-2">
                                <h3 class="text-bold">
                    ...
                    <div class="flex flex-col flex-grow p-4 text-center">
                        ...
                        <div class="flex justify-center px-1 pb-2">
                            <div class="button-group inline-flex text-center">
                                <a href="{{ route('portfolio.edit', $info->id) }}" class="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
